...
2. **Deploy from Git**
   ...
   - Set **Build output directory** to `pages`
...
- Verify **Build output directory** is set to `pages`
- Ensure `pages/index.html` exists

**Site 404s after deploy**

- Verify `pages/` folder has your HTML files
- Check build logs in Pages dashboard
- Try manual deploy: `wrangler pages deploy pages/`
